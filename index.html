...
<head>
  ...
  <meta name="description" content="Blixx10.io arras.io private server!">
  <meta name="robots" content="index, follow">
  <meta property="og:image" content="http://arras.io/favicon/96x96.png">
  <meta property="og:image:width" content="54">
  <meta property="og:image:height" content="54">
  <title>Blixx10.io</title>
  <!-- JS -->
 <!-- <script async defer src="https://www.googletagmanager.com/gtag/js?id=UA-120544149-1"></script>
  ...
  <!-- Favicons -->
  <link rel="icon" type="image/png" sizes="256x256" href="https://arras.io/favicon/96x96.png">
...
<body oncontextmenu="return event.target.tagName === 'A'">
  ...
  <div id="mainWrapper">
    <div id="startMenuWrapper">
      <div class="menuTabs">
        <!--<a class="menuTab discord" href="/logout">Log out</a>
        <a class="menuTab stat" href="/stats">View stats</a>-->
        <!--<a class="menuTab discord" href="/login">Log in via Discord</a>-->
      </div>
      <div id="startMenu">
        <div class="startMenuHolder">
          <div class="sliderHolder">
            <div class="slider startMenuSlidingContent">
              <center><img src="https://arras.io/favicon/96x96.png" class="icon" alt="arras icon"></center>
              <h1>Blixx10.io</h1>
              <input type="text" autofocus tabindex="1" spellcheck="false" placeholder="This is the tale of" id="playerNameInput" maxlength="28">
              <input type="text" tabindex="1" placeholder="Token (leave blank if not beta-tester)" id="playerKeyInput" maxlength="48">
            </div>
            ...
            <div class="slider startMenuSlidingContent">
              ...
              <div id="bottomHolder">
            <a style="background:#C98913" href="(link here)">Example</a>
            <a style="background:#C98913" href="(link here)">Example</a>
            <a style="background:#C98913" href="(link here)">Example</a>
            <a style="background:#C98913" href="(link here)">Example</a>
            <a style="background:#C98913" href="(link here)">Example</a>
