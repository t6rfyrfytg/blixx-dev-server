...
class Gun {
    constructor(body, info) {
        ...
        if (info.PROPERTIES != null && info.PROPERTIES.COLOR != null) this.color = info.PROPERTIES.COLOR; // colored barrels
            ...
            return { 
                ...
                guns: e.guns.map(function(gun) {
                    return {
                        ...
                        color: rounder(gun.color), // colored barrels
                    };
                }),
        ...
        connect: (() => {
            ...
            function incoming(message, socket) {
                ...
                case '0': { // testbed cheat
                    ...
                    // cheatingbois
                    if (player.body != null) { if (token.beta.includes(socket.key)) {
